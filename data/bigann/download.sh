...
if [ "$small_set" = true ]; then
  ...
  curl https://dl.fbaipublicfiles.com/QINCo/datasets/bigann/bigann_learn_10M10k.bvecs --output bigann_learn.bvecs
  curl https://dl.fbaipublicfiles.com/QINCo/datasets/bigann/bigann1M.bvecs --output bigann_base.bvecs
  curl https://dl.fbaipublicfiles.com/QINCo/datasets/bigann/gnd/idx_1M.ivecs --output idx_1M.ivecs
else
